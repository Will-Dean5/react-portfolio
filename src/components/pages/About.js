...
const About = () => {
  return (
    ...
    <p className='' style={{color: 'white',display: 'flex', justifyContent: 'center', fontSize: '20px', marginLeft: '380px', marginRight: '380px'}}>Hi my name is Will Dean and This is my first react portfolio. I am excited that you are checking it out. I am currently a student enrolled in a full stack web development bootcamp, I took AP computer science in highschool, I am having a great time learning in this full stack bootcamp. This seemed like something I would want to pursue for a career because it gives you so many opportunitys to explore your creativity. I believe in making webpages with 100% effort and making everything as perfect as it can be.</p>
